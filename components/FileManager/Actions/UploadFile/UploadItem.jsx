    ...
    return new Promise((resolve, reject) => {
      ...
      xhr.onload = () => {
        ...
        try {
          ...
          setIsUploaded(true);
          onFileUploaded(jsonResponse);
          resolve(jsonResponse);
        } catch (error) {
          console.error("Upload Response Parsing Error:", xhr.responseText);
      ...
      console.log("Uploading File Data:", { fileName: fileData.file.name, parentId: appendData.parentId });
  ...
  return (
    <li>
      ...
      <div className="file">
        ...
        {/* {fileData.error && <span className="file-error">{fileData.error}</span>} ✅ Show error */}
        <Progress

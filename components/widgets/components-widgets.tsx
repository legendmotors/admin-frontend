                ...
                <div className="grid sm:grid-cols-2 xl:grid-cols-3 gap-6 mb-6">
                    <div className="panel h-full sm:col-span-2 xl:col-span-1 pb-0">
                        ...
                        <div className="border-t border-white-light dark:border-white/10">
                            <Link href="/" className=" font-semibold group hover:text-primary p-4 flex items-center justify-center group">
                                View All
                            ...
                            <table>
                                ...
                                <tbody>
                                    <tr className="text-white-dark hover:text-black dark:hover:text-white-light/90 group">
                                        ...
                                        <td>170</td>
                                        <td>
                                            <Link className="text-danger flex items-center" href="/">
                                    ...
                                    <tr className="text-white-dark hover:text-black dark:hover:text-white-light/90 group">
                                        ...
                                        <td>130</td>
                                        <td>
                                            <Link className="text-success flex items-center" href="/">
                                                <IconMultipleForwardRight className="rtl:rotate-180 ltr:mr-1 rtl:ml-1" />
                                                Google
                                            </Link>
                                        </td>
                                    ...
                                    <tr className="text-white-dark hover:text-black dark:hover:text-white-light/90 group">
                                        ...
                                        <td>66</td>
                                        <td>
                                            <Link className="text-warning flex items-center" href="/">
                                                <IconMultipleForwardRight className="rtl:rotate-180 ltr:mr-1 rtl:ml-1" />
                                                Ads
                                            </Link>
                                        </td>
                                    ...
                                    <tr className="text-white-dark hover:text-black dark:hover:text-white-light/90 group">
                                        ...
                                        <td>35</td>
                                        <td>
                                            <Link className="text-secondary flex items-center" href="/">
                                                <IconMultipleForwardRight className="rtl:rotate-180 ltr:mr-1 rtl:ml-1" />
                                                Email
                                            </Link>
                                        </td>

                        ...
                        <ul className="relative space-y-0.5 p-4 py-0 font-semibold">
                            ...
                            <li className="menu nav-item">
                                <button type="button" className={`${currentMenu === 'brand' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('brand')}>
                                    <div className="flex items-center">
                                        <IconMenuDashboard className="shrink-0 group-hover:!text-primary" />
                                        <span className="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">{t('brand')}</span>
                                    </div>
                            ...
                            <li className="menu nav-item">
                                <Link href="https://legend motors.sbthemes.com" target="_blank" className="nav-link group">
                                    <div className="flex items-center">

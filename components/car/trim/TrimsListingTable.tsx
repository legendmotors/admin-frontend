...
const CarModelListingTable: React.FC = () => {
    ...
    return (
        <div className="container mx-auto">
            <h1 className="text-2xl font-bold mb-4">Trims Listing</h1>
            <ReusableTable
                modelName="Trim"
                ...
                listService={TrimService.listTrim}
                deleteService={TrimService.deleteTrim}
                bulkDeleteService={TrimService.bulkDeleteTrims}
                actions={actions}
